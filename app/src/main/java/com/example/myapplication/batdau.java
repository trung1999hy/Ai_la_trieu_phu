   ...
   DatabaseHandler databaseHandler;
        ...
        textToSpeech = new TextToSpeech(batdau.this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int i) {
                if ( i != TextToSpeech.ERROR) {
                    ...
                    Toast.makeText(batdau.this, "Errol", Toast.LENGTH_LONG).show();
                }
                if (txcauhoi != null) {
                    textToSpeech.speak(txcauhoi.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
    ...
    public void onClick(View v) {
        ...
        if (!limit) {
            ...
            v.setBackgroundResource(R.drawable.xanhduong);
            switch (v.getId()) {
                case R.id.cauA:
    ...
    public void Ketthuc(int vang) {
        ...
        ten = (EditText) view.findViewById(R.id.eddten);
        Button btketthuc = (Button) view.findViewById(R.id.btnketthuc);
        tvFinish.setText("Bạn đã dành được " + vang + " điểm. Cảm ơn bạn đã tham gia " +
